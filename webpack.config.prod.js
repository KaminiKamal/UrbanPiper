...
export default {
  ...
  plugins: [
    ...
    new CopyWebpackPlugin([{ from: 'src/assets/css/*', to: 'assets/css/[name].[ext]' } ]),
    new CopyWebpackPlugin([{ from: 'src/assets/fonts/*', to: 'assets/fonts/[name].[ext]' } ]),
    new CopyWebpackPlugin([{ from: 'src/assets/js/*', to: 'assets/js/[name].[ext]' } ]),
    new CopyWebpackPlugin([{ from: 'src/assets/img/*', to: 'assets/img/[name].[ext]' } ]),
